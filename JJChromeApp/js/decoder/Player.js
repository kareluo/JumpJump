...
(function (root, factory) {
  ...
  var Player = function(parOptions){
    ...
    this._config.workerFile = this._config.workerFile || "./js/decoder/Decoder.js";
    ...
    if (this._config.useWorker){
      ...
      if (this._config.transferMemory){
        ...
        this.decode = function(parData, parInfo){
          ...
          // copyU8.set( parData, 0, parData.byteLength );
          worker.postMessage({buf: copyU8.buffer, offset: 0, length: copyU8.length, info: parInfo}, [copyU8.buffer]); // Send data to our worker.
        };
